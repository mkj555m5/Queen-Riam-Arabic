const __qrPaths = require('./paths'); const __qrDataFile = __qrPaths.dataFile;
const fs = require("fs");
const pathMod = require("path");
function _ugdPath(sock){const sid=sock&&sock._sessionNumber?sock._sessionNumber:null;return sid?__qrDataFile("userGroupData_"+sid+".json"):__qrDataFile("userGroupData.json");}
