 ...
 * سورس بوت Rimuru MD 👑
 * مزوّد Baileys ومزوّدو الـ API والمِخرَجات Scrappers — تحياتهم محفوظة
 *
 * لا تحذف الاعتمادات ولا تستبدلها
 *
 * القناة الرسمية: https://whatsapp.com/channel/0029VbB37bgBfxoAmAlsgE0t
 *
 */
import fs from 'fs'
