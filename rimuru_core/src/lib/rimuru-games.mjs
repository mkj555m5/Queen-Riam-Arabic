import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./rimuru-game-data.mjs";
import { getDatabase } from "./rimuru-database.mjs";
import { addExpWithLevelCheck } from "./rimuru-level.mjs";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./rimuru-context.mjs";
...
let fetchBuffer;
try {
  fetchBuffer = (await import("./rimuru-utils.mjs")).fetchBuffer;
} catch { }
