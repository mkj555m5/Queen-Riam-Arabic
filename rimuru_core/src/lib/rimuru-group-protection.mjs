import { downloadMediaMessage } from "../../ourin_shim.mjs";
import { isLid, lidToJid, lidToJidSafe } from "./rimuru-lid.mjs";
...
function gpMsg(key, replacements = {}) {
  const defaults = {
    ...
    antilinkKick: "⚠ *مانع الروابط* — @%user% طُرد لإرسال رابط.",
    antilinkGc: "⚠ *مانع روابط واتساب* — @%user% أرسل رابط مجموعة واتساب.\nتم حذف الرسالة.",
    antilinkGcKick:
      "⚠ *مانع روابط واتساب* — @%user% طُرد لإرسال رابط مجموعة واتساب.",
    antilinkAll: "⚠ *مانع الروابط* — @%user% أرسل رابطاً.\nتم حذف الرسالة.",
    antilinkAllKick: "⚠ *مانع الروابط* — @%user% طُرد لإرسال رابط.",
    antitagsw: "⚠ *مانع الإشارة للحالات* — تم حذف إشارة حالة من @%user%.",
    antiswgc: "⚠ *مانع حالات المجموعات* — تم حذف حالة من نوع *%type%* من @%user%.",
    antijudol:
      "⚠ *مانع المقامرة* — تم رصد @%user% وهو يرسل محتوى قماراً.\nتم حذف الرسالة.",
    antijudolKick: "⚠ *مانع المقامرة* — @%user% طُرد لإرسال محتوى قماراً.",
    antiphising:
      "⚠ *مانع التصيّد* — تم رصد @%user% وهو يرسل محتوى تصيّداً.\nتم حذف الرسالة.",
    antiphisingKick:
      "⚠ *مانع التصيّد* — @%user% طُرد لإرسال محتوى تصيّداً.",
    anticustom:
      "⚠ *قاعدة مخصصة* — @%user% خالف القاعدة المخصصة *%rule%*.\nتم حذف الرسالة.",
    anticustomKick:
      "⚠ *قاعدة مخصصة* — @%user% طُرد لخالفه القاعدة المخصصة *%rule%*.",
    antiviewonce: "👁️ *عار المرة الواحدة* — من @%user%",
    antiremove: "🗑️ *مانع الحذف* — @%user% حذف رسالة:",
    antihidetag: "⚠ *مانع الإخفاء* — تم حذف إشارة مخفية من @%user%.",
    notAdmin: "⚠ البوت ليس مشرفاً، لا يمكنه حذف الرسالة.",
  };
    ...
    try {
      ...
      if (msgContent) {
        ...
        if (
          ...
          const { downloadMediaMessage } = await import("../../ourin_shim.mjs");
          const fakeMsg = {
            key: cached.key,
          ...
          const { generateWAMessageFromContent } = await import("../../ourin_shim.mjs");
          const cleanContent = {};
      ...
      try {
        ...
        if (msgType === "conversation") {
          ...
          await sock.sendMessage(
            chatId,
            { text: "[مانع الحذف] تم حذف رسالة (النوع: " + msgType + ")" },
            { quoted: headerMsg },
          );
        }
      } catch (e2) {}
