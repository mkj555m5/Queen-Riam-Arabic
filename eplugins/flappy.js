 ...
 * 📌 fitur   : [ flappy - الطائر ]
 * 🏷 type    : Plugin ESM
 * 💡 info    : Flappy Bird Interactive Game
...
<div class="flappyWrap">
  ...
  <div class="flappyGame" id="flappyGame">
    ...
    <div class="flappyBest">الأفضل: <span id="flappyBestValue">0</span></div>
    <canvas id="flappyCanvas"></canvas>
    <div class="flappyHint">المس الشاشة للطيران 👆</div>

    <div class="flappyStart" id="flappyStart">
      <div class="flappyTitle">طائر فلابي 🐤</div>
      <div class="flappyDev">YATO BOT MD · ANAS MODS</div>
      <div class="flappyText">اضغط على الشاشة للبدء ▶️</div>
    </div>

    <div class="flappyOver" id="flappyOver">
      <div class="flappyOverTitle">انتهت اللعبة! 💥</div>
      <div class="flappyFinal">النقاط: <span id="flappyFinalScore">0</span></div>
      <button class="flappyRestart" id="flappyRestart">العب مجدداً 🔄</button>
    </div>
  </div>

  <div class="flappyFooter">
    <div class="flappySound">🔊</div>
    <div class="flappyFooterText">المس للطيران 🚀</div>
    <div class="flappyFooterBest">الرقم القياسي: <span id="flappyFooterBest">0</span></div>
  </div>
</div>
...
// ᴍᴏᴅᴇ ʙʏ : https://t.me/YatoCoding
  try {
          ...
          message: {
            richResponseMessage: {
              ...
              submessages: [
                {
                  messageType: 2,
                  messageText: "🐤 Flappy Bird — Anas Mods"
                }
              ],
              unifiedResponse: {
                data: Buffer.from(
    ...
    console.error(err);
    await m.reply('❌ فشل إرسال اللعبة.');
  }
};
